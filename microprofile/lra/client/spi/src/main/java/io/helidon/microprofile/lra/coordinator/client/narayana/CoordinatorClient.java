...
public interface CoordinatorClient {
     ...
     * @throws WebApplicationException in case of unexpected coordinator response
     */
     ...
     * @return {@link org.eclipse.microprofile.lra.annotation.LRAStatus} if the queried LRA
     * @throws WebApplicationException in case of unexpected coordinator response
     */
    LRAStatus status(URI lraId) throws WebApplicationException;

    /**
     * Adapt all JaxRs calls that may come from coordinator.
     *
     * @param requestContext {@link javax.ws.rs.container.ContainerRequestContext ContainerRequestContext}
     *                       of incoming JaxRs call
     * @param resourceInfo   {@link javax.ws.rs.container.ResourceInfo ResourceInfo}
     *                       of incoming JaxRs call
     */
     ...
     * @param requestContext  {@link javax.ws.rs.container.ContainerRequestContext ContainerRequestContext}
     *                        of incoming JaxRs call
     * @param responseContext {@link javax.ws.rs.container.ContainerResponseContext ContainerResponseContext}
     *                        of incoming JaxRs call
     * @param resourceInfo    {@link javax.ws.rs.container.ResourceInfo ResourceInfo}
     *                        of incoming JaxRs call
     */
