...
//        if (true) return ShrinkWrap.create(JavaArchive.class);
        ...
        archive
                .addPackages(true, LRAClient.class.getPackage())
                .addPackages(true, Current.class.getPackage())
...
//        archive
//                .addPackages(true, io.narayana.lra.filter.ClientLRARequestFilter.class.getPackage())
